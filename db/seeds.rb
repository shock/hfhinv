...
DEPARTMENTS = {
  ...
  "Furniture" => [
    ...
    {name: "Couch/Loveseat", code: "Couch", notes: "note color/pattern, with ottoman?"},
    ...
    {name: "Chest/Trunk", code: "Trunk", notes: "note color, material"},
  ...
  "Tools" => [
    {name: "Hand Tools", code: "HandTool", notes: "brief description, if unique"},
    {name: "Power Tools", code: "PowerTool", notes: "note maker and type, or describe"},
  ],
  "Electronics" => [
